...
/** Google OAuth is opt-in per deployment: set NEXT_PUBLIC_AUTH_GOOGLE=1
 *  (frontend) + AUTH_GOOGLE_ID/SECRET (Convex env) to show the button.
 *  The public demo + fresh clones run password/guest-only, so visitors
 *  never see a Google button that errors for lack of credentials. */
