...
import { buildSearchText } from "./_shared/search";
...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // [database-silong template] webhook emission removed for portability.
    // Consumer projects that want event hooks can add `internal.webhooks.deliver.run`
    // calls here. See CONVEX-BACKEND.md "Adding webhooks" section.
    return pageId;
  },
});
