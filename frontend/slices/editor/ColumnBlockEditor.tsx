  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="mt-1 h-auto p-0 gap-1 text-xs font-normal text-muted-foreground/60 hover:bg-transparent hover:text-muted-foreground opacity-0 group-hover/col:opacity-100 transition [&_svg]:size-3"
      >
