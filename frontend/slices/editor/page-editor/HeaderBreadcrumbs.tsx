      ...
      {parentDb && (
        <>
          <Button
            ...
            className="flex h-auto items-center gap-1.5 px-1.5 py-1 min-w-0 text-sm font-normal text-muted-foreground"
          >
      ...
      {crumbs.map((c, i) => (
        <div key={c.id} className="flex items-center gap-1 min-w-0">
          ...
          <Button
            ...
            className={cn(
              "flex h-auto items-center gap-1.5 px-1.5 py-1 min-w-0 text-sm font-normal",
