...
export function RowButton({ icon: Icon, label }: { icon: LucideIcon; label: string }) {
  return (
    <Button variant="ghost" className="flex w-full h-auto items-center gap-2 px-3 py-1.5 text-sm font-normal justify-start rounded-none [&_svg]:size-3.5">
...
export function Row({
  ...
  return (
    <Button
      ...
      onClick={onClick}
      className={cn(
        "flex w-full h-auto items-center gap-2 px-3 py-1.5 text-sm font-normal justify-start rounded-none [&_svg]:size-3.5",
