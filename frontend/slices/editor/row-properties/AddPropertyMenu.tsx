    ...
    <div className="border-t border-border/40">
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" className="flex w-full h-auto items-center gap-1.5 text-xs font-normal text-muted-foreground hover:text-foreground px-3 py-2 justify-start [&_svg]:size-3.5">
