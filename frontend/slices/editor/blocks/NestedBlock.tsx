  ...
  return (
    ...
    >
      <Button
        ...
        className="mt-1 h-5 w-4 p-0 shrink-0 cursor-grab rounded text-muted-foreground/50 opacity-0 group-hover/nested:opacity-100 active:cursor-grabbing [&_svg]:size-3.5"
      >
