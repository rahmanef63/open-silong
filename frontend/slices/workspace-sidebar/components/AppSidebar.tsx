    ...
    <Sidebar collapsible="icon" data-keyboard-scope>
      ...
      <SidebarFooter className="gap-2">
        <Button
          ...
          aria-label="New page"
          title="New page"
          className="flex w-full h-auto items-center gap-2 rounded-md bg-foreground px-2.5 py-1.5 text-sm font-medium text-background hover:bg-foreground hover:opacity-90 group-data-[collapsible=icon]:size-8 group-data-[collapsible=icon]:!p-0 group-data-[collapsible=icon]:justify-center justify-start"
        >
