  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" className={cn(cellClass, "w-full h-auto text-left px-2 py-1 rounded hover:bg-accent/50 font-normal justify-start")}>
          {opt
      ...
      <PopoverContent className="w-64 p-1">
        <div className="space-y-0.5 max-h-60 overflow-y-auto">
          ...
          <Button variant="ghost" onClick={() => onSet(null)} className="w-full h-auto px-2 py-1 rounded text-xs font-normal text-muted-foreground justify-start [&_svg]:size-3">
...
export function MultiSelectCell({
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" className={cn(cellClass, "w-full h-auto text-left px-2 py-1 rounded hover:bg-accent/50 flex flex-wrap gap-1 font-normal justify-start")}>
