...
export function DateEditor({ value, prop, onChange, onClear, onPropPatch }: Props) {
  ...
  return (
    <div className="w-[300px] p-2">
      ...
      <Button variant="ghost" onClick={onClear} className="mt-2 h-auto w-full justify-start rounded px-2 py-1 text-sm font-normal text-muted-foreground">Clear</Button>
    </div>
  );
}
