...
export function OptionRow({ db, propId, option, selected, onSelect }: {
  ...
  return (
    <div className="flex items-center gap-1 group/opt px-1 rounded hover:bg-accent">
      <Button variant="ghost" onClick={onSelect} className="h-auto min-w-0 flex-1 justify-start gap-1 py-1 px-0 text-left text-sm font-normal hover:bg-transparent">
      ...
      <div className="flex items-center gap-0.5 opacity-0 group-hover/opt:opacity-100 shrink-0">
        <Button
          ...
          className="h-auto rounded p-0.5 text-[10px] font-normal leading-none text-muted-foreground hover:bg-muted"
          title="Change color"
        >
          o
        </Button>
        <Button
          ...
          className="h-auto rounded p-0.5 text-muted-foreground hover:bg-muted [&_svg]:size-3"
          title="Rename"
        >
        ...
        <Button
          ...
          className="h-auto rounded p-0.5 text-muted-foreground hover:bg-muted hover:text-destructive [&_svg]:size-3"
          title="Delete"
        >
          <X className="h-3 w-3" />
        </Button>
  ...
  return (
    <div className="border-t border-border mt-1 pt-1 px-1">
      ...
      >
        ...
        />
        <Button type="submit" variant="ghost" className="h-auto rounded p-1 text-muted-foreground [&_svg]:size-3"><Plus className="h-3 w-3" /></Button>
      </form>
    </div>
  );
}
