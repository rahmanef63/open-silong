        ...
        <div className="space-y-2">
            ...
            {candidates.map((p) => {
              ...
              return (
                <Button
                  ...
                  variant="ghost"
                  onClick={() => toggle(p.id)}
                  className="h-auto w-full justify-start gap-2 rounded px-2 py-1.5 text-left text-sm font-normal [&_svg]:size-3.5"
                >
          ...
          {targetDb && (
            <Button
              variant="ghost"
              onClick={onCreateNew}
              className="h-auto w-full justify-start gap-2 rounded-md border border-dashed border-border px-2 py-1.5 text-xs font-normal text-muted-foreground hover:bg-accent hover:text-foreground [&_svg]:size-3.5"
            >
