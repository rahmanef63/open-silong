    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-64 p-1">
        ...
        <Button
          ...
          className="flex w-full h-auto items-center gap-2 rounded px-2 py-1.5 text-xs font-normal justify-start [&_svg]:size-3.5"
        >
        ...
        >
          <Button
            type="button"
            variant="ghost"
            className="flex w-full h-auto items-center gap-2 rounded px-2 py-1.5 text-xs font-normal justify-start"
          >
        ...
        <Button
          ...
          className="flex w-full h-auto items-center gap-2 rounded px-2 py-1.5 text-xs font-normal hover:bg-destructive/10 text-destructive hover:text-destructive justify-start [&_svg]:size-3.5"
        >
      ...
      <DropdownMenuContent align="end" className="w-64 max-h-96 overflow-y-auto">
        <DropdownMenuLabel className="flex items-center justify-between text-xs">
          ...
          <div className="flex gap-1 text-[10px] font-normal">
            <Button variant="link" onClick={showAll} className="h-auto p-0 text-[10px] font-normal text-muted-foreground">Show all</Button>
            <span className="text-muted-foreground/40">·</span>
            <Button variant="link" onClick={hideAll} className="h-auto p-0 text-[10px] font-normal text-muted-foreground">Hide all</Button>
          </div>
        </DropdownMenuLabel>
        {db.properties.map((p: Property) => {
          ...
          return (
            ...
            >
              <Button variant="ghost" onClick={() => toggle(p.id)} className="flex h-auto items-center gap-2 flex-1 min-w-0 text-left px-0 py-0 font-normal hover:bg-transparent justify-start [&_svg]:size-3.5">
              ...
              <Button variant="ghost" size="icon" onClick={() => deleteProperty(db.id, p.id)} className="h-auto w-auto p-0 ml-1 text-muted-foreground hover:text-destructive hover:bg-transparent [&_svg]:size-3.5" title="Delete property (all views)">
